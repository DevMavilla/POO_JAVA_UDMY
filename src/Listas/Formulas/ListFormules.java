package Listas.Formulas;
import java.util.ArrayList;
import java.util.List;
import java.util.stream.Collectors;

public class ListFormules {
    public static void main(String[] args){
        ...
        System.out.println("---------------------------");
        /*Primeiro converte para Stream* - faz a operação Lambda que precisar .filter(...) - Depois converter para lista collect.../ */
        ...
        /* DEVOOLVE NULL CASO NÃO ENCONTRE */
